...
import { getAuthCallbackURL, getSafeRedirect } from "../lib/auth-redirect.ts";
...
export function SignIn() {
  ...
  const errorCallbackURL =
    safeRedirect === "/" ? "/sign-in" : `/sign-in?redirect=${encodeURIComponent(safeRedirect)}`;
  ...
  return (
    <div className="min-h-screen p-4 md:p-6 flex justify-center items-center">
      <div className="sm:max-w-[340px] w-full space-y-6">
        <h1 className="text-lg font-medium tracking-tight text-center">Sign in to Pages CMS</h1>
        <Button
          type="button"
          className="w-full"
