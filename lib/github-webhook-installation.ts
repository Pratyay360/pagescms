...
import { cacheFileTable, collaboratorTable, githubInstallationTokenTable } from "../db/schema.ts";
...
import { deleteCacheFileMeta, deleteCacheFileMetaByPaths } from "./github-cache-meta.ts";
