...
import { RepoSelect } from "../../components/repo/repo-select.tsx";
import { RepoTemplates } from "../../components/repo/repo-templates.tsx";
import { RepoLatest } from "../../components/repo/repo-latest.tsx";
...
import { getVisits } from "../../lib/tracker.ts";
      ...
      <div className="max-w-screen-sm mx-auto p-4 md:p-6 space-y-8">
        {user.accounts.length > 0 ? (
          <div className="min-h-[calc(100vh-12rem)] flex flex-col justify-center space-y-8">
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-medium tracking-tight">Open a project</h2>
              <RepoSelect onAccountSelect={(account) => setDefaultAccount(account)} />
            </div>
            {isGithubUser && (
              <div className="space-y-4">
                <h2 className="text-lg font-medium tracking-tight">Create from a template</h2>
          ...
          <Empty className="absolute inset-0 border-0 rounded-none">
            <EmptyHeader>
              ...
              <EmptyDescription>
                Install the GitHub App on at least one account before you can open or create
                projects.
              </EmptyDescription>
            </EmptyHeader>
            <EmptyContent>
          ...
          <Empty className="absolute inset-0 border-0 rounded-none">
            <EmptyHeader>
              ...
              <EmptyDescription>
                You need an invitation to a repository before you can collaborate. Ask a repository
                owner or organization admin to invite you.
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        )}
